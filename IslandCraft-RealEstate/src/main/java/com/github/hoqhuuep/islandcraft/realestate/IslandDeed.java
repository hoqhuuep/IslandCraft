...
public class IslandDeed {
    ...
    @AttributeOverrides({@AttributeOverride(name = "world", column = @Column(name = "inner_world")),
        @AttributeOverride(name = "minX", column = @Column(name = "inner_min_x")), @AttributeOverride(name = "minY", column = @Column(name = "inner_min_y")),
        @AttributeOverride(name = "minZ", column = @Column(name = "inner_min_z")), @AttributeOverride(name = "maxX", column = @Column(name = "inner_max_x")),
        @AttributeOverride(name = "maxY", column = @Column(name = "inner_max_y")), @AttributeOverride(name = "maxZ", column = @Column(name = "inner_max_z"))})
    private SerializableRegion innerRegion;

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "world", column = @Column(name = "outer_world")),
        @AttributeOverride(name = "minX", column = @Column(name = "outer_min_x")), @AttributeOverride(name = "minY", column = @Column(name = "outer_min_y")),
        @AttributeOverride(name = "minZ", column = @Column(name = "outer_min_z")), @AttributeOverride(name = "maxX", column = @Column(name = "outer_max_x")),
        @AttributeOverride(name = "maxY", column = @Column(name = "outer_max_y")), @AttributeOverride(name = "maxZ", column = @Column(name = "outer_max_z"))})
