...
public interface ICDatabase {
     ...
     * @return the name of the owner of the island. <code>null</code> if the
     *         island is not owned. "<code>&ltreserved></code>" or "
     *         <code>&ltresource></code>" if this it is a special island.
     */
     ...
     * @return a list containing the locations of all islands owned by the given
     *         player
     */
     ...
     *            the location of the center of the island
     * @param player
     *            the new owner of the island. If <code>null</code> the
     *            ownership will be removed from the database.
     */
